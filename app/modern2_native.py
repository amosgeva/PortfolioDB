...
def render_advisor(get_conn, put_conn, watchlist=None) -> None:
    ...
    st.caption(
        "Everything below is generated by **your** model — your key, or a local "
        "model on this machine — measured against the one-pager **you** wrote. "
        "It is not investment advice, and it is not a broker or an adviser. "
