...
<div class="report">
{body}
<div class="footer">Generated by PortfolioDB · {escape(d.as_of.strftime('%Y-%m-%d %H:%M %Z'))}<br>
Informational only — not investment advice, not tax figures, and no substitute for a licensed adviser.
This file is a standalone artefact: it travels without the app or its README, so the caveat travels with it.</div>
</div>
</body>
</html>
"""
